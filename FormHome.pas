...
begin
  ...
  frmReporteListadoProductos.FormReporte.Conexion.BeginTrans();
  frmReporteListadoProductos.FormReporte.Conexion.CommitTrans();

  frmReporteListadoProductos.FormReporte.Datos.DataSet.Refresh;
  frmReporteListadoProductos.FormReporte.Consulta.Refresh;

  // frmReporteListadoProductos.FormReporte.reporte.Enabled := False;
  // frmReporteListadoProductos.FormReporte.reporte.Enabled := True;
  frmReporteListadoProductos.FormReporte.reporte.DataSet.Refresh;
